...
class TestCases:
    def test_create_case(self, qase, create_project):
        ...
        res = qase.cases.create(code=create_project, body=body)
    ...
    def test_get_all_cases(self, qase, create_project):
        ...
        res_cases = qase.cases.get_all(code=create_project)
    ...
    def test_delete_case(self, qase, create_project):
        ...
        res_delete = qase.cases.delete(code=create_project, uuid=uuid_case)
    ...
    def test_update_case(self, qase, create_project):
        ...
        body["title"] = name_test_case
        res_update = qase.cases.update(code=create_project, uuid=uuid_case, body=body)
